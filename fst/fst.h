...
typedef enum {
  ...
  FST_SPEAKER(ArrStereoSurround, 2),
  FST_SPEAKER(ArrStereoCenter, 3),
  FST_SPEAKER(ArrStereoSide, 4),
  FST_SPEAKER(ArrStereoCLfe, 5),
  FST_SPEAKER(Arr30Cine, 6),
  FST_SPEAKER(Arr30Music, 7),
  FST_SPEAKER(Arr31Cine, 8),
  FST_SPEAKER(Arr31Music, 9),
  FST_SPEAKER(Arr40Cine, 10),
  FST_SPEAKER(Arr40Music, 11),
  FST_SPEAKER(Arr41Cine, 12),
  FST_SPEAKER(Arr41Music, 13),
  FST_SPEAKER(Arr50, 14),
  FST_SPEAKER(Arr51, 15),
  FST_SPEAKER(Arr60Cine, 16),
  FST_SPEAKER(Arr60Music, 17),
  FST_SPEAKER(Arr61Cine, 18),
  FST_SPEAKER(Arr61Music, 19),
  FST_SPEAKER(Arr70Cine, 20),
  FST_SPEAKER(Arr70Music, 21),
  FST_SPEAKER(Arr71Cine, 22),
  FST_SPEAKER(Arr71Music, 23),
  FST_SPEAKER(Arr80Cine, 24),
  FST_SPEAKER(Arr80Music, 25),
  FST_SPEAKER(Arr81Cine, 26),
  FST_SPEAKER(Arr81Music, 27),
